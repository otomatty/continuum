...
mod tests {
    ...
    fn test_generate_preview_long_text() {
        let body = "This is a very long text that should be truncated because it exceeds the maximum length";
        let preview = generate_preview(body, 20);
    ...
    fn test_sort_by_created_at_desc() {
        let discussions = vec![
            create_test_discussion_with_dates("1", "2025-01-01T00:00:00Z", "2025-01-01T00:00:00Z", 0, 0),
            create_test_discussion_with_dates("2", "2025-01-03T00:00:00Z", "2025-01-03T00:00:00Z", 0, 0),
            create_test_discussion_with_dates("3", "2025-01-02T00:00:00Z", "2025-01-02T00:00:00Z", 0, 0),
        ];
    ...
    fn test_sort_by_updated_at_desc() {
        let discussions = vec![
            create_test_discussion_with_dates("1", "2025-01-01T00:00:00Z", "2025-01-05T00:00:00Z", 0, 0),
            create_test_discussion_with_dates("2", "2025-01-03T00:00:00Z", "2025-01-03T00:00:00Z", 0, 0),
            create_test_discussion_with_dates("3", "2025-01-02T00:00:00Z", "2025-01-04T00:00:00Z", 0, 0),
        ];
    ...
    fn test_sort_by_comments_desc() {
        let discussions = vec![
            create_test_discussion_with_dates("1", "2025-01-01T00:00:00Z", "2025-01-01T00:00:00Z", 5, 0),
            create_test_discussion_with_dates("2", "2025-01-01T00:00:00Z", "2025-01-01T00:00:00Z", 20, 0),
            create_test_discussion_with_dates("3", "2025-01-01T00:00:00Z", "2025-01-01T00:00:00Z", 10, 0),
        ];
    ...
    fn test_sort_by_reactions_desc() {
        let discussions = vec![
            create_test_discussion_with_dates("1", "2025-01-01T00:00:00Z", "2025-01-01T00:00:00Z", 0, 15),
            create_test_discussion_with_dates("2", "2025-01-01T00:00:00Z", "2025-01-01T00:00:00Z", 0, 30),
            create_test_discussion_with_dates("3", "2025-01-01T00:00:00Z", "2025-01-01T00:00:00Z", 0, 5),
        ];
